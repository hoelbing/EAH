 ...
 * For translators: please use UTF-8 if possible.  We strongly believe that Unicode is the answer to a real internationalized
 * world.  Also please include your contact information in the header, as can be seen above.
 */

// full day names
Calendar._DN                    = new Array("Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag","Sonntag");

/* Please note that the following array of short day names (and the same goes for short month names, _SMN) isn't absolutely
 * necessary.  We give it here for exemplification on how one can customize the short day names, but if they are simply the
 * first N letters of the full name you can simply say:
 *
 * Calendar._SDN_len = N; // short day name length
 * Calendar._SMN_len = N; // short month name length
 * 
 * If N=  then this is not needed either since we assume a value of 3 if not present, to be compatible with translation files
 * that were written before this feature.
 */
